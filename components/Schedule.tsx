...
const Schedule = () => {
	return (
		<div className="flex flex-col px-4 py-6 gap-4 pt-[6rem]">
			<h1 className="text-[2rem] chakra mx-auto flex items-center justify-center pb-[1rem] mb-4 border-b-[1px] border-neutral-800 w-full">
				Schedule
			</h1>
			{/* 
